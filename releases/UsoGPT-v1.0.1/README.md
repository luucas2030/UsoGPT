...
### Extensao Chrome para monitorar uso do ChatGPT Plus e Claude
...
Uma extensao Chrome leve e segura que monitora automaticamente seu uso do ChatGPT Plus e Claude, exibindo:
...
| ChatGPT e Claude | Selecione o serviço a monitorar no popup |

---

## Versao 1.0.1

- Adicionado monitoramento de uso do Claude, incluindo as janelas de 5 horas e 7 dias.
- Adicionado seletor de servico no popup; o badge acompanha o servico escolhido.
...
3. Escolha o servico (ChatGPT ou Claude) e qual metrica mostrar no badge:
   - **5-Hour**: Limite de 5 horas
   - **7-Day**: Limite semanal

### Passo 4: Use

1. Acesse [chatgpt.com](https://chatgpt.com) ou [claude.ai](https://claude.ai)
...
A extensao utiliza endpoints autenticados do ChatGPT e Claude:
...
GET https://claude.ai/api/organizations/<organizacao>/usage
```
